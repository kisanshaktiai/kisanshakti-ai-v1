        ...
        <>
          ...
          >
            <div className="flex items-center justify-between p-4 border-b border-border">
              ...
              <h2 className="font-semibold text-foreground">{t('post.create')}</h2>
              <Button
            ...
            <div className="p-4 overflow-y-auto max-h-[50vh]">
              ...
              {isTranscribing && (
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex items-center gap-2 mt-3 p-3 bg-primary/10 rounded-xl">
                  ...
                  <span className="text-sm text-primary">{t('post.converting')}</span>
                </motion.div>
              )}
              ...
              {voiceNoteUrl && (
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="mt-4 p-3 bg-secondary/50 rounded-xl flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium">{t('post.voice')}</p>
                  </div>
            ...
            <div className="p-4 border-t border-border bg-secondary/30">
              ...
              <p className="text-center text-xs text-muted-foreground mt-3">
                {isRecording ? t('post.release_to_stop') : t('post.hold_mic')}
              </p>
            </div>
          </motion.div>
        </>
