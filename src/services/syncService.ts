            ...
            if (db) {
              ...
              for (const c of crops) {
                await store.put({
                  ...
                  // Cache every supported language label so offline UI is
                  // also localized — kept in sync with src/lib/i18nRef.ts.
                  label_hi: c.label_hi || null,
                  label_mr: c.label_mr || null,
                  label_pa: c.label_pa || null,
                  label_ta: c.label_ta || null,
                  label_te: c.label_te || null,
                  label_bn: c.label_bn || null,
                  label_gu: c.label_gu || null,
                  label_kn: c.label_kn || null,
                  label_ml: c.label_ml || null,
                  label_or: c.label_or || null,
                  label_as: c.label_as || null,
                  label_ur: c.label_ur || null,
                  label_sa: c.label_sa || null,
