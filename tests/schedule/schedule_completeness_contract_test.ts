...
// The field-condition layer became the decision layer (schedule-reconciler/decision-application.ts);
// its contracts live in decision_loop_contract_test.ts, so the weather-adaptation assertions are retired.
