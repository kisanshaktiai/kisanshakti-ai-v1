...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `You are an experienced agricultural scientist with 50+ years of combined traditional farming wisdom 
                          and modern agro-technology expertise. You are an expert agricultural specialist with proven methods 
                          to increase crop yields by Min 3x to 7x beyond standard recommendations. You understand both scientific 
                          principles and rural farmer realities across all Indian states and agro-climatic zones.
...
TASK RULES:
- Generate 12-20 tasks covering full crop cycle
