...
const NUM_RE = /\d+(?:[.,]\d+)?/g; const CHUNK_SIZE = 10; const MAX_CONCURRENCY = 4; const NARRATION_BUDGET_MS = 90_000; const MAX_OUTPUT_TOKENS = 4_500; const RETRY_DELAYS_MS = [2_000, 5_000]; const MAX_RETRY_AFTER_MS = 8_000; let rateLimited = false;
