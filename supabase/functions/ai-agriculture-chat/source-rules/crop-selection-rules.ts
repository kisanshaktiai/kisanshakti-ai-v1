 ...
 * ═══════════════════════════════════════════════════════════════════════════
 * 
 * BACKEND-ONLY: This module contains proprietary crop selection logic.
...
export function getCropRecommendations(input: CropSelectionInput): CropSelectionResult {
  ...
  const sortedCrops = scoredCrops
    .filter(c => c.suitability_score >= 30)
...
function getSowingWindow(cropCode: string, season: string, currentMonth: number): {
  ...
  const windows: Record<string, Record<string, { start: number; end: number; optimal: string }>> = {
    wheat: { rabi: { start: 10, end: 11, optimal: 'October 15 - November 15' } },
    rice: { kharif: { start: 6, end: 7, optimal: 'June 15 - July 15' } },
    soybean: { kharif: { start: 6, end: 7, optimal: 'June 15 - July 10' } },
    cotton: { kharif: { start: 5, end: 6, optimal: 'May 15 - June 30' } },
    gram: { rabi: { start: 10, end: 11, optimal: 'October 15 - November 15' } },
    sugarcane: {
    ...
    groundnut: { kharif: { start: 6, end: 7, optimal: 'June 15 - July 10' } },
    maize: {
      kharif: { start: 6, end: 7, optimal: 'June 15 - July 15' },
      rabi: { start: 10, end: 11, optimal: 'October 15 - November 15' }
    },
